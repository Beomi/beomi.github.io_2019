---
title: "편리한 깃헙페이지 블로깅을 위한 이미지서버, 구글드라이브"
...
## 추가예정: 앱으로 만들어 단축키로 연결하기

MacOS에서 sh파일을 App으로 wrapping을 하면 키보드로 매핑이 가능합니다. 다만, 현재 앱으로 래핑할 경우 정상적으로 URL을 받아오지 못하는 오류가 있어 연구중입니다.

독자분들의 도움이 필요합니다! 

좋은 아이디어가 있으시면 페이스북 메신저로 연락주세요. ([Facebook링크](https://facebook.com/Junbum.L))
