...
- HowToMakeWebCrawler
published: true
image: https://beomi-tech-blog.s3.ap-northeast-2.amazonaws.com/img/2017-02-27-HowToMakeWebCrawler-Save-with-Django/python+django.jpg
---
...
![django install success]({{site.static_url}}/img/dropbox/2017-02-28%2017.14.57.png)
...
![startproject websaver]({{site.static_url}}/img/dropbox/2017-02-28%2017.15.47.png)
...
![tree websaver]({{site.static_url}}/img/dropbox/2017-02-28%2017.18.06.png)
...
![startapp parsed_data]({{site.static_url}}/img/dropbox/2017-02-28%2017.32.06.png)
...
![First migrate]({{site.static_url}}/img/dropbox/2017-02-28%2017.37.23.png)
...
![parsed_data app migration]({{site.static_url}}/img/dropbox/2017-02-28%2017.58.01.png)
...
![project folder tree]({{site.static_url}}/img/dropbox/2017-02-28%2018.05.30.png)
...
![createsuperuser]({{site.static_url}}/img/dropbox/2017-02-28%2018.18.49.png)
...
![django runserver]({{site.static_url}}/img/dropbox/2017-02-28%2018.26.07.png)

이제 [http://localhost:8000/admin/](http://localhost:8000/admin/)로 들어가 봅시다.

![Django admin login page]({{site.static_url}}/img/dropbox/2017-02-28%2018.27.23.png)

아까 `createsuperuser`로 만든 계정으로 로그인 해 봅시다.

![django admin page]({{site.static_url}}/img/dropbox/2017-02-28%2018.28.09.png)

우리가 만든 `parsed_data`앱 안에 `BlogData`라는 항목이 나와있는 것을 볼 수 있습니다.

![blogdata admin list]({{site.static_url}}/img/dropbox/2017-02-28%2018.28.54.png)

`BlogData object`라는 이름으로 데이터들이 들어와 있는 것을 확인할 수 있습니다. 하나를 클릭해 들어가 보면 아래와 같이 title와 link가 성공적으로 들어와 있는 것을 볼 수 있습니다.

![blogdata specific data]({{site.static_url}}/img/dropbox/2017-02-28%2018.29.43.png)
...
![title list admin page]({{site.static_url}}/img/dropbox/2017-02-28%2018.38.11.png)
